    ...
    <div class="px-4 py-5 sm:p-6">
      <div class="w-full max-w-sm space-y-6">
        <div class="text-center">
          ...
          <div class="text-gray-400 dark:text-gray-400 mt-1">
        ...
        <div class="gap-y-6 flex flex-col">
          ...
          <form class="space-y-6" data-n-ids='{"nQC7NdK6Niw-0":"nQC7NdK6Niw-0"}'>
            <div class="" data-n-ids='{"ns301bmYiru-0":"ns301bmYiru-1"}'>
              <div class="">
                <div class="flex content-center items-center justify-between text-sm">
                  <label for="ns301bmYiru-1" class="block font-medium text-gray-700 dark:text-gray-200">Email</label>
                </div>
              </div>
            ...
            <div class="" data-n-ids='{"ns301bmYiru-0":"ns301bmYiru-2"}'>
              <div class="">
                <div class="flex content-center items-center justify-between text-sm">
                  <label for="ns301bmYiru-2" class="block font-medium text-gray-700 dark:text-gray-200">Password</label
                  ><span class="text-gray-400 dark:text-gray-400"
                    ><a href="/" class="text-primary font-medium">Forgot password?</a></span
                  >
                </div>
              </div>
              <div class="mt-1 relative">
        ...
        <p class="text-sm text-gray-400 dark:text-gray-400 mt-2 text-center">
          By signing in, you agree to our <a href="/" class="text-primary font-medium">Terms of Service</a>.
        </p>
      </div>
    </div>
  </div>
