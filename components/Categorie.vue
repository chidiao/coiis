<template>
  ...
  >
    <div>
      <img
        src="https://rapidapi.com/hub/_next/image?url=https%3A%2F%2Frapidapi-prod-collections.s3.amazonaws.com%2Fcategory%2Fsports.svg.xml&w=3840&q=75"
        class="size-6"
      />
      ...
      <div class="text-xs text-blue-500 hover:underline">Browse Category</div>
    </div>
  </div>
</template>
